function Footer() {
    ...
    return ( 
        <footer style={{backgroundColor:'rgb(240,240,240)'}}>
            <div className="container text-muted mt-5 border-top ">
                <div className="row mb-5 mt-5">
                    <div className="col">
                        <img src="media/images/logo.svg" alt="" style={{width:'60%'}}/>
                        <p className="mt-4">&copy; 2010 - 2024, zerodha Broking Ltd. All rights reserved.</p>
                    </div>
                    <div className="col mx-5" >
                        <p className="fs-5 text-dark">Company</p>
                        <a href="">About</a><br />
                    ...
                    <div className="col">
                        <p className="fs-5 text-dark">Support</p>
                    ...
                    <div className="col">
                        <p className="fs-5 text-dark">Account</p>
